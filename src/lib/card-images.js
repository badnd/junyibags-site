...
// Prefer each product's published clean card image. Older records without one
// retain the established thumbnail-path fallback.
export const productCardImage = (slug, product) => product?.cardImage || `assets/images/junyi/products/${slug}/thumb-card.webp`;
