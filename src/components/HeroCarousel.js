...
export function HeroCarousel({ slides, proofLine, positioningLine, mockupText, footnote }) {
  ...
  return (
    <section className="hero" onPointerDown={handlePointerDown} onPointerUp={handlePointerUp} onPointerCancel={() => { touchStartX.current = null; }}>
      ...
      <div className="container hero-grid">
        <div className="hero-copy">
          ...
          {mockupText ? <div className="hero-mockup"><strong>Free Artwork Mockup</strong><span>{mockupText}</span></div> : null}
