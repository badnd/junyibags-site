  ...
  return (
    <div className="quote-card ru-quote-card">
      ...
      <form className="inquiry-form">
        <label><span>Интересующий товар</span><input name="product" defaultValue={product} /></label>
        <label><span>Планируемое количество</span><input name="quantity" placeholder="50 / 100 / 300 / 500 / 1 000 / 3 000+ шт" /></label>
        ...
        <label><span>Email / WhatsApp</span><input name="contact" placeholder={siteData.company.email} /></label>
        <label><span>Комментарий</span><textarea name="message" rows="4" placeholder="Опишите модель, размер, цвет, упаковку и целевой рынок." /></label>
