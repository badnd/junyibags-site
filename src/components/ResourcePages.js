...
const origin = 'https://www.junyibags.com';
...
export function ResourceArticle({ page, locale = 'en' }) {
  ...
  const schemas = [
    { '@context': 'https://schema.org', '@type': 'Article', headline: content.title, description: page.meta[locale].description, datePublished: '2026-07-28', dateModified: '2026-07-28', author: { '@type': 'Organization', name: 'Junyi Bags' }, publisher: { '@type': 'Organization', name: 'Junyi Bags' }, mainEntityOfPage: url },
